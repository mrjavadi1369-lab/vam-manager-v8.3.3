    ...
    // Jalali today (YYYY-MM-DD). تاریخ‌های اقساط نیز شمسی ذخیره می‌شوند؛
    // استفاده از تاریخ میلادی در اینجا باعث می‌شد همهٔ اقساط پرداخت‌نشده
    // (مثلاً ۱۴۰۵-۰۶-۱۵) در مقایسه با ۲۰۲۶-۰۹-۰۶ «معوق» تشخیص داده شوند.
